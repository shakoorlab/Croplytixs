    ...
    MuiChip: {
      styleOverrides: {
        root: {
          ...
          // frosted pill: hairline edge, inset top highlight, soft black drop
          ...theme.applyStyles('dark', {
            backgroundImage: 'linear-gradient(180deg, rgba(255, 255, 255, 0.07), rgba(255, 255, 255, 0.02))',
            backdropFilter: 'blur(8px)',
            border: '1px solid rgba(255, 255, 255, 0.1)',
            boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.09), 0 2px 8px rgba(0, 0, 0, 0.35)'
          }),
